...
class ClientDemo
{
    ...
    { /*
        ...
        */
        ...
        int connectionResult = client.ConnectTo("192.168.90.81", 0, 2);
        ...
        while (true)
        {
            ...
            {
               // Console.WriteLine("conenction ok");
            ...
            var BufferM = new byte[24];
            int readResult = client.DBRead(1, 0, Buffer.Length, Buffer);
            int readResultM = client.MBRead(5, 24, BufferM);
            ...
            {
                Console.WriteLine("db1 read NOT ok");
                return;
            }
            float db1dbw4 = S7.GetRealAt(Buffer, 4);
            int db1dbw2 = S7.GetIntAt(Buffer, 2);
            float db1dbd8 = S7.GetRealAt(Buffer, 8);
            int MB5 = S7.GetSIntAt(BufferM, 0);
            int MB5_1 = S7.GetSIntAt(BufferM, 1);

            //  Console.WriteLine(db1dbw4);
            // Console.WriteLine(db1dbw2);
            //  Console.WriteLine(db1dbd8);

            System.Threading.Thread.Sleep(30);
                Console.WriteLine("MB5" + MB5);
                Console.WriteLine("MB5(1)" + MB5_1);
